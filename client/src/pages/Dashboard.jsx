  ...
  return (
    <div className="min-h-[calc(100vh-3.75rem)] bg-[#F7F3FF] px-4 py-8 sm:px-6 lg:h-[calc(100vh-3.75rem)] lg:px-8 lg:py-10">
      <div className="mx-auto flex h-full max-w-7xl items-center justify-center rounded-3xl bg-white shadow-sm">
        ...
        <div className="relative z-20 w-full max-w-md rounded-3xl border border-[#6B2E93]/10 bg-white px-6 py-6 text-center shadow-2xl shadow-[#6B2E93]/20 sm:px-8 sm:py-8">
          <div className="mx-auto flex h-12 w-12 items-center justify-center rounded-full bg-[#F4ECFF] text-xl font-bold text-[#6B2E93]">
            !
          </div>
